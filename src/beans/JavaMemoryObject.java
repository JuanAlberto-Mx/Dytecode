...
/**
 * <code>JavaMemoryObject</code> class wraps bytecode into memory.This class extends the
 * <code>StandardFileManager</code> class functionality to read and write bytecode into
 * memory instead of class files.
