...
/**
 * <code>CompiledClassList</code> class represents a set of compiled classes and allows all
 * of them to be loaded as a package if needed. <code>CompiledClassList</code> class is
 * useful to deal with inner classes and inner interfaces.
